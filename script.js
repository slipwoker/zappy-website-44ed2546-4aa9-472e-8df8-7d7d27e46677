document.addEventListener('DOMContentLoaded', function () {
  ...
  function clearFormErrors(form) {
    ...
    if (formSuccess) formSuccess.remove();
  }
      ...
      if (!el.dataset.animateDelay && !el.dataset.delay) {
        const siblings = el.parentElement
          ? Array.from(el.parentElement.children).filter(function (child) {
              return child.matches(OBSERVE_SELECTORS.join(', '));
            })
          : [];
        const siblingIndex = siblings.indexOf(el);
        if (siblingIndex > 0) {
          el.dataset.animateDelay = (siblingIndex * 0.12).toFixed(2);
        }
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Omer Squishy משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '44ed2546-4aa9-472e-8df8-7d7d27e46677',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '44ed2546-4aa9-472e-8df8-7d7d27e46677';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '44ed2546-4aa9-472e-8df8-7d7d27e46677';
